...
function occupiedRoomsPerEpi(occupiedRoomsList) {
	...
	for(i=0; i < EPI_1.length; i++){
		...
		occupiedRooms_epi1.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 2 :
	for(i=0; i < EPI_2.length; i++){
		...
		occupiedRooms_epi2.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 3 :
	for(i=0; i < EPI_3.length; i++){
		...
		occupiedRooms_epi3.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 4 :
	for(i=0; i < EPI_4.length; i++){
		...
		occupiedRooms_epi4.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 5 :
	for(i=0; i < EPI_5.length; i++){
		...
		occupiedRooms_epi5.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 6 :
	for(i=0; i < EPI_6.length; i++){
		...
		occupiedRooms_epi6.push(item.room);
		break;
	    }
	}
	// Filtrage EPI 1 :
	for(i=0; i < AUTRES.length; i++){
		...
		occupiedRooms_autres.push(item.room);
		break;
	    }
	}
    })
