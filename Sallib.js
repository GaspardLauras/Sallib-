...
>>>>>>> 0bfcd3b645b8c97a9895a948b18b41300dbd3f50
...
function getEvents(sessionId){
    ...
    fetch(proxyUrl + events)
        ...
        .then(data => {
            ...
            // Filtrage par épi :
            var occupiedRooms = occupiedRoomsPerEpi(processedList);
            console.log(occupiedRooms);   // utilisable en faisant occupiedRooms.epi1 etc.// utilisable en faisant occupiedRooms.epi1 etc.
